...
glm::vec3 pointLightPositions[] = {
        glm::vec3( 50.0f,  27.0f,  0.0f),
        glm::vec3( 50.4f,  34.4f,  0.4f),
        glm::vec3(51.4f,  35.0f,  0.0f),
        glm::vec3( 51.0f,  35.4f,  0.4f)
};
...
int main() {
    ...
    Shader cubeShader("resources/shaders/6.1.cubemaps.vs", "resources/shaders/6.1.cubemaps.fs");
    Shader skyboxShader("resources/shaders/6.1.skybox.vs", "resources/shaders/6.1.skybox.fs");

    Shader lightingShader("resources/shaders/4.2.lighting_maps.vs", "resources/shaders/4.2.lighting_maps.fs");
    Shader lightCubeShader("resources/shaders/4.2.light_cube.vs", "resources/shaders/4.2.light_cube.fs");

    Shader multipleLightingShader("resources/shaders/6.multiple_lights.vs", "resources/shaders/6.multiple_lights.fs");

    Shader advancedLight("resources/shaders/advancedLight.vs", "resources/shaders/advancedLight.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        multipleLightingShader.use();
        multipleLightingShader.setVec3("viewPos", programState->camera.Position);
        ...
        model = glm::translate(model, glm::vec3(49.0f, 24.0f, 0.0f));
        ...
        model2 = glm::translate(model2, glm::vec3(50.0, 24.0f, 34.0f));
